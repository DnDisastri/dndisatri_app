 ...
 * Origine: equipment.js — CLASS_EQUIP
 *
        ...
        'choices' => [
            [
                ...
                'options' => [
                    ...
                    [
                        'label' => 'Arma da guerra (Spada Lunga)',
                        'items' => [
                            [
                                'name' => 'Spada Lunga',
                                'category' => 'Armi',
            ...
            [
                'label' => 'Armi secondarie',
                'options' => [
                    [
                        'label' => 'Due Asce da Battaglia',
                        'items' => [
                            [
        ...
        'choices' => [
            ...
            [
                ...
                'options' => [
                    ...
                    [
                        'label' => 'Arma da mischia semplice (Mazza)',
                        'items' => [
                            [
                                'name' => 'Mazza',
                                'category' => 'Armi',
