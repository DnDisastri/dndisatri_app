...
// === DATI DI GIOCO (moduli ES estratti da app.js) ===
import {
  CLASS_SPELL_LIST, CLASS_SPELL_ABILITY, SPELLS_KNOWN_L1,
  FULL_CASTER_SLOTS, HALF_CASTER_SLOTS, THIRD_CASTER_SLOTS, WARLOCK_SLOTS,
  normalizeSpellName, SPELL_LIST, SPELL_LIB
} from './src/data/spells.js?v=36';
...
// CLASS_SPELL_LIST → src/data/spells.js
...
// normalizeSpellName, SPELL_LIST, SPELL_LIB → src/data/spells.js
